		...
		<div id="main">
			<div class="holder margin_bottom_25">
				<div id="secondary_top" class="border_bottom_30">
                    ...
                    <?php
                    $count = 1;
                    $right_side = ( of_get_option('of_sn_nr2') / 2 ) + 1;
                    function get_col_name($i, $max){
                        $right_side = ( $max / 2 ) + 1;
                        if($i >= $right_side) echo "last";
                        else echo "border_right_15";
                    }
                    ...
                    ?>
                        ...
                        <?php if($count == 1 || $count == $right_side ):?>
                            <div class="col_wide  <?php get_col_name($count, of_get_option('of_sn_nr2')); ?>">
                        ...
                        <?php if (intval(of_get_option('of_sn_nr2')) > 0 ) { ?>
								...
								<span class="postmeta<?php if ($count == of_get_option('of_sn_nr2')) { echo " lastpost"; } ?>">
                                    <b>Date:</b> <?php echo get_the_date(''); ?> <br />
                        ...
                        <?php gab_dynamic_sidebar( 'Se_Top_Mid2' ); ?>
                                <?php if($count == ($right_side - 1 ) || $count == of_get_option('of_sn_nr2')):?>
                            </div>
                    <?php endif;?>
