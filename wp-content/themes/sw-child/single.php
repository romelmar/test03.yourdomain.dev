            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                <div id="post-<?php the_ID(); ?>" <?php post_class('entry holder margin_bottom_25'); ?>>
                    ...
                    <div class="metasingle">
                        ...
                        <span class="postcategory"><?php _e('Filed under', 'snapwire'); ?>: <?php the_category(',') ?>
                            &nbsp;&nbsp;|&nbsp;&nbsp;</span>
                        <span class="postauthor"><?php _e('Posted by', 'snapwire'); ?>
                    ...
                    the_post_thumbnail(array(180), array('class' => 'alignleft'));
                    // Display content
                    the_content();
                    ...
                    if (of_get_option('of_short_url') == 1) {
                        ...
                        echo '<input type="text" class="small_text span-1" onclick="this.focus(); this.select();" value="';
                        wp_get_shortlink();
                        echo '">';
                        echo '</p>';
                    }
